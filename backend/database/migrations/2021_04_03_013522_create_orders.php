...
class CreateOrders extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->integer('branch_no_issue')->nullable()->comment('枝番号');
            ...
            $table->integer('shipping_fee')->nullable()->comment('送料');
            $table->integer('fee')->nullable()->comment('手数料');
            $table->integer('discount')->nullable()->comment('値引き');
            $table->integer('inclusive_sum')->nullable()->comment('総合計');
            ...
            $table->date('delivery_specified_date')->nullable()->comment('配送指定日');
            $table->time('delivery_specified_time')->nullable()->comment('配送指定時間');
            ...
            $table->date('return_date')->nullable()->comment('返品日');
            ...
            $table->mediuminteger('fixed_term_times')->nullable()->comment('定期回数');
            $table->string('fixed_term_delivery_cycle')->comment('定期お届け周期');
            $table->date('next_delivery_plan_latest')->nullable()->comment('次回お届け予定（最新）');
            ...
            $table->integer('shipping_fee_2')->nullable()->comment('送料2');
            $table->integer('fee_2')->nullable()->comment('手数料2');
            $table->integer('discount_2')->nullable()->comment('値引き2');
            $table->integer('inclusive_sum_2')->nullable()->comment('総合計2');
            $table->date('delivery_due_date')->nullable()->comment('発送予定日');
            $table->date('next_delivery_expected_date')->nullable()->comment('次回発送予定日');
            ...
            $table->date('fixed_term_order_date')->nullable()->comment('定期注文日');
            ...
            $table->integer('internal_tax_etc')->nullable()->comment('内消費税等');
            ...
            $table->date('pause_date')->nullable()->comment('休止日');
