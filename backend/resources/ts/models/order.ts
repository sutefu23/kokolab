...
export type Order = {
    id: number; //テーブルID
    reception_date: string; //受付日
    reception_time: string; //受付時間
    ...
    next_delivery_plan_latest: string; //次回お届け予定（最新）
